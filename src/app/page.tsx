    ...
    <div className="bg-[#131313] text-[#e5e2e1] min-h-screen flex flex-col selection:bg-[#4d8eff] selection:text-[#00285d]">
      ...
      <main className="flex-grow flex flex-col relative overflow-hidden">
        ...
        <section className="relative pt-20 pb-28 px-4 md:px-8 lg:px-16 flex flex-col items-center text-center z-10">
          ...
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[650px] bg-[#adc6ff] opacity-5 blur-[140px] rounded-full pointer-events-none" />

          <div className="max-w-4xl mx-auto space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded border border-[#383b47] bg-[#181818] text-[#adc6ff] font-code text-xs mb-2">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-6">
              <Link
                href="/workspaces"
                className="bg-[#adc6ff] text-[#002e6a] font-semibold px-8 py-3 rounded-sm hover:bg-[#d8e2ff] transition-all flex items-center gap-2 w-full sm:w-auto justify-center glow-effect shadow-[0_0_25px_rgba(173,198,255,0.3)]"
              >
              ...
              <button
                ...
                className="border border-[#383b47] bg-[#181818] text-[#e5e2e1] px-8 py-3 rounded-sm hover:bg-[#201f1f] transition-colors flex items-center gap-2 w-full sm:w-auto justify-center"
              >
          ...
          <div className="mt-16 w-full max-w-5xl relative animate-float">
            <div className="glass-panel rounded-lg overflow-hidden border border-[#383b47] shadow-2xl relative z-10 bg-[#0a0a0a]">
              {/* Editor Header */}
              <div className="bg-[#1c1b1b] flex items-center px-4 py-2 border-b border-[#2d2d2d]">
                ...
                <div className="flex gap-1 overflow-hidden">
                  ...
                  <div className="px-4 py-1 text-[#8c909f] font-code text-xs flex items-center gap-2">
                ...
                <div className="ml-auto flex items-center gap-3">
                  <div className="flex -space-x-1.5">
                    <div className="w-6 h-6 rounded-full bg-[#4d8eff] border border-[#1c1b1b] flex items-center justify-center text-[10px] font-bold text-white">
                      SJ
                    </div>
                    <div className="w-6 h-6 rounded-full bg-[#ffb786] border border-[#1c1b1b] flex items-center justify-center text-[10px] font-bold text-[#502400]">
                      AL
                    </div>
                  </div>
                  <div className="bg-[#2a2a2a] px-2 py-0.5 rounded-sm font-code text-[11px] text-[#adc6ff] flex items-center gap-1">
              ...
              <div className="flex h-[380px] text-left">
                {/* Line Numbers */}
                <div className="w-12 bg-[#0e0e0e] border-r border-[#2d2d2d] flex flex-col text-right pr-3 py-4 font-code text-xs text-[#8c909f] select-none leading-[24px]">
                  <span>1</span>
                  <span>2</span>
                  <span>3</span>
                  <span>4</span>
                ...
                <div className="flex-1 bg-[#0a0a0a] p-4 font-code text-xs md:text-sm leading-[24px] overflow-hidden relative">
                  ...
                  <div className="absolute top-[195px] left-[240px] flex items-center pointer-events-none">
                    ...
                    <div className="bg-[#ffb786] text-[#502400] font-code text-[9px] px-1 py-0.5 rounded-sm ml-1 font-semibold whitespace-nowrap shadow-md">
                      Sarah J.
                    </div>
                  </div>

                  {/* AI Suggestion Overlay */}
                  <div className="absolute top-[215px] left-[60px] bg-[#201f1f] border border-[#383b47] rounded-md p-3 shadow-2xl glass-panel max-w-sm">
                    <div className="flex items-center gap-2 mb-1.5 border-b border-[#2d2d2d] pb-1.5">
                    ...
                    <div className="flex gap-2 mt-2.5">
                      <button
                        ...
                        className="bg-[#2a2a2a] text-[#e5e2e1] text-[11px] px-2.5 py-1 rounded-sm border border-[#383b47] hover:bg-[#353534] transition-colors"
                      >
          ...
          <div className="mt-20 w-full max-w-4xl flex flex-col items-center">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 md:gap-10 text-xs font-code text-[#c2c6d6]">
              <div className="flex items-center gap-2 border border-[#2d2d2d] px-3.5 py-1.5 rounded-sm bg-[#181818]">
        ...
        <section
          id="velocity"
          className="py-24 px-4 md:px-8 lg:px-16 bg-[#0e0e0e] border-t border-[#2d2d2d] relative z-20"
        >
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
              ...
              <div className="md:col-span-2 bg-[#181818] border border-[#2d2d2d] rounded-lg p-6 flex flex-col justify-between overflow-hidden relative group hover:border-[#adc6ff] transition-colors">
                <div className="relative z-10 mb-6">
                  <div className="w-10 h-10 bg-[#201f1f] rounded-sm flex items-center justify-center mb-4 border border-[#2d2d2d]">
                ...
                <div className="relative h-44 bg-[#0a0a0a] border border-[#2d2d2d] rounded-md overflow-hidden p-4 font-code text-xs text-[#8c909f] group-hover:border-[#adc6ff]/50 transition-colors">
              ...
              <div className="bg-[#181818] border border-[#2d2d2d] rounded-lg p-6 flex flex-col justify-between overflow-hidden relative group hover:border-[#adc6ff] transition-colors">
                <div className="relative z-10 mb-6">
                  <div className="w-10 h-10 bg-[#201f1f] rounded-sm flex items-center justify-center mb-4 border border-[#2d2d2d]">
                ...
                <div className="relative h-44 bg-[#121212] border border-[#2d2d2d] rounded-md flex items-center justify-center overflow-hidden">
                  <div className="flex items-center gap-4 relative z-10">
                    <div className="w-12 h-12 rounded-full border-2 border-[#adc6ff] bg-[#1c1b1b] flex items-center justify-center shadow-lg">
                      <span className="font-code text-xs font-bold text-[#adc6ff]">
                        SJ
                      </span>
                    </div>
                    <div className="w-16 h-[2px] bg-[#2d2d2d] relative">
                      <div className="absolute inset-0 bg-[#adc6ff] w-full animate-pulse"></div>
                    </div>
                    <div className="w-12 h-12 rounded-full border-2 border-[#ffb786] bg-[#1c1b1b] flex items-center justify-center shadow-lg">
              ...
              <div className="md:col-span-3 bg-[#181818] border border-[#2d2d2d] rounded-lg p-6 overflow-hidden relative group hover:border-[#d0bcff] transition-colors border-l-2 hover:border-l-[#d0bcff]">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    >
                      <span>Read the technical brief</span>
                  ...
                  <div className="bg-[#0a0a0a] border border-[#2d2d2d] rounded-md p-4 font-code text-xs relative">
                    <div className="absolute top-0 left-0 w-1 h-full bg-[#d0bcff] opacity-70"></div>
                    <div className="text-[#8c909f] mb-2 border-b border-[#2d2d2d] pb-2 flex items-center gap-2">
                      <span className="material-symbols-outlined text-[#d0bcff] text-[16px]">
                        robot_2
                      </span>
                      <span>Ask AI</span>
                    ...
                    <div className="text-[#c2c6d6] bg-[#1c1b1b] p-2.5 rounded border border-[#2d2d2d] mt-2 leading-relaxed">
        ...
        {/* CTA Section */}
        <section className="py-24 px-4 relative flex justify-center items-center overflow-hidden border-t border-[#2d2d2d]">
          <div className="absolute inset-0 bg-[#141414]" />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#2a2a2a]/40 via-[#131313] to-[#131313]" />
          <div className="relative z-10 max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                href="/workspaces"
                className="bg-[#adc6ff] text-[#002e6a] font-semibold px-8 py-3 rounded-sm hover:bg-[#d8e2ff] transition-colors"
              >
                Start Free Trial
              </Link>
              <button
                onClick={() => setShowSalesModal(true)}
                className="border border-[#383b47] bg-[#1c1b1b] text-[#e5e2e1] px-8 py-3 rounded-sm hover:bg-[#252525] transition-colors"
              >
                Contact Sales
              </button>
            </div>
